...
$(function () {
    ...
    window.onscroll = (ev)=>{
        ...
        for( $i = 0 ;$i<$len ; $i++ ){
            $html+=` <li data-id = "${$obj[$i].id}">
                    ...
                    <div class="price">
                        ...
                        <a href="#" onclick = "return false" class="buynow">立即购买></a>
                    </div>
                </li>`;
        }
     ...
     /*-----------点击立即购买----------- */ 
      $('.tentent-bottom-right ul').on('click','.buynow',function(){
         var id = $(this).parent().parent().attr('data-id');
        //  console.log(id)
        window.open('html/xiangqingye.html?id='+id);
      });
});